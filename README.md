...
and tell the person sitting next to you what your guess is.
   ...
   |                        | `str` | `list` | `deque` |
   | ---------------------- | ----- | ------ | ------- |
   | `check_palindrome_1`   |  O(n) | O(n)   | O(2n^2) |
...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   | 3.94 msec per loop | 4.09 msec per loop | 63.3 msec per loop |
| `check_palindrome_2`   | 3.34 msec per loop | 2.92 msec per loop | 2.94 msec per loop |
